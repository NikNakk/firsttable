...
<!-- badges: start -->
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/NikNakk/firsttable?branch=main&svg=true)](https://ci.appveyor.com/project/NikNakk/firsttable)
...
[![Codecov test coverage](https://codecov.io/gh/NikNakk/firsttable/branch/main/graph/badge.svg)](https://codecov.io/gh/NikNakk/firsttable?branch=main)
<!-- badges: end -->
